...
const Navbar = () => {
    ...
    const links = <div className='md:flex items-center justify-center'>
        ...
        <li><NavLink to="/order" className={({ isActive }) => isActive ? "text-cyan-400 font-bold underline" : "text-cyan-500"}>Order Now</NavLink></li>
    ...
    return (
        <div className="fixed top-0 left-1/2 transform -translate-x-1/2 z-10 navbar shadow-sm w-full max-w-6xl">
            <div className="navbar-start">
                ...
                <Link to='/' className="btn btn-ghost text-xl">Bistro<span className='text-cyan-500'>BOSS</span></Link>
            </div>
